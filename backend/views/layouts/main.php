    ...
    <head>
        ...
        <style>
            ...
            .pagination li.prev, .pagination li.next {
                background-color: rgb(101 148 193);
                color: #a5a4a4;
                font-size: 22px;
            }
            .pagination .active {
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= Yii::$app->homeUrl ?>">
                ...
                <div class="sidebar-brand-text mx-3">Мой склад</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= \yii\helpers\Url::to(['/product']) ?>">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="<?= Url::to(['/product/remains']) ?>">
                            ...
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle"
                                     src="<?= Yii::$app->homeUrl ?>img/undraw_profile.svg">
                            </a>
        ...
        <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">Нажмите «Выход» ниже, если вы готовы завершить текущий сеанс.</div>
